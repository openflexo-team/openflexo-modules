 ...
 * @author yourname
 */
public class FMEClipboard extends FlexoClipboard {

	private static final Logger logger = Logger.getLogger(FMEClipboard.class.getPackage().getName());

	protected FMESelectionManager _xxxSelectionManager;

	public FMEClipboard(FMESelectionManager aSelectionManager, JMenuItem copyMenuItem, JMenuItem pasteMenuItem, JMenuItem cutMenuItem) {
		super(aSelectionManager, copyMenuItem, pasteMenuItem, cutMenuItem);
		_xxxSelectionManager = aSelectionManager;
		resetClipboard();
	}

	public FMESelectionManager getSelectionManager() {

 ...
 * @author yourname
 */
public class FMEEditMenu extends EditMenu {

	private static final Logger logger = Logger.getLogger(FMEEditMenu.class.getPackage().getName());
	...
	public FMEEditMenu(FMEController controller) {
		super(controller);

...
public class FIBConceptBrowser extends FIBBrowserView<FMEFreeModelInstance> {
	static final Logger logger = Logger.getLogger(FIBConceptBrowser.class.getPackage().getName());

	public static final Resource FIB_FILE = ResourceLocator.locateResource("Fib/Widget/FIBConceptBrowser.fib");

	public FIBConceptBrowser(FMEFreeModelInstance freeModel, FMEController controller) {

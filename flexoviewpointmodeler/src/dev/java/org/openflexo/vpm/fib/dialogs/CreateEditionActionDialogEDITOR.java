...
public class CreateEditionActionDialogEDITOR extends FIBAbstractEditor {
	...
	public Object[] getData() {
		...
		CreateEditionAction action = CreateEditionAction.actionType.makeNewAction(vp.getDefaultDiagramSpecification().getFlexoConcepts()
	...
	public File getFIBFile() {
		return VPMCst.CREATE_EDITION_ACTION_DIALOG_FIB;
	}

	public static void main(String[] args) {
		main(CreateEditionActionDialogEDITOR.class);
	}

...
public class TestOMInspectors extends GenericFIBInspectorTestCase {
	...
	public static void main(String[] args) {
		System.out.println(generateInspectorTestCaseClass(((FileResourceImpl) ResourceLocator.locateResource("Inspectors/OM")).getFile(),
				"Inspectors/OM/"));
	}

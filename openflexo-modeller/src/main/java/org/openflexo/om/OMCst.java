...
/**
 * Constants used by the {@link OpenflexoModeller} module.
 * 
 * @author sylvain
 */
public class OMCst {

	public static final String DEFAULT_OM_BROWSER_WINDOW_TITLE = "Openflexo Modeller";

	public static final int DEFAULT_OM_BROWSER_WINDOW_WIDTH = 300;

	public static final int DEFAULT_OM_BROWSER_WINDOW_HEIGHT = 250;

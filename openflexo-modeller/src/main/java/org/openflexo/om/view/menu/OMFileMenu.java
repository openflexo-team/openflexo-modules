...
/**
 * 'File' menu for {@link OpenflexoModeller} Module
 * 
 * @author sylvain
 */
@SuppressWarnings("serial")
public class OMFileMenu extends FileMenu {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(OMFileMenu.class.getPackage().getName());

	public OMFileMenu(OMController controller) {
		super(controller);
	}

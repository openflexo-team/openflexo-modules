...
/**
 * 
 * Contextual menu manager for {@link OpenflexoModeller} module
 * 
 * @author sylvain
 */
public class OMContextualMenuManager extends ContextualMenuManager {

	public OMContextualMenuManager(OMSelectionManager selectionManager, OMController controller) {

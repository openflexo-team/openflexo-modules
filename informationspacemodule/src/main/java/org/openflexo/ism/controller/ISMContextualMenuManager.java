 ...
 * @author yourname
 */
public class ISMContextualMenuManager extends ContextualMenuManager {

	private ISMController _controller;

	public ISMContextualMenuManager(ISMSelectionManager selectionManager, ISMController controller) {

 ...
 * @author yourname
 */
public class ISMWindowMenu extends WindowMenu {

	private static final Logger logger = Logger.getLogger(ISMWindowMenu.class.getPackage().getName());
	...
	protected ISMController ismController;

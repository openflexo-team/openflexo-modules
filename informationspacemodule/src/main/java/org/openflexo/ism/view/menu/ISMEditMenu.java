 ...
 * @author yourname
 */
public class ISMEditMenu extends EditMenu {

	private static final Logger logger = Logger.getLogger(ISMEditMenu.class.getPackage().getName());
	...
	public ISMEditMenu(ISMController controller) {
		super(controller);

 ...
 * @author sylvain
 */
public class ISMFileMenu extends FileMenu {

	private static final Logger logger = Logger.getLogger(ISMFileMenu.class.getPackage().getName());
	...
	public ISMFileMenu(ISMController controller) {
		super(controller);

 ...
 * @author sylvain
 */
public class EAMSelectionManager extends MouseSelectionManager {

	protected static final Logger logger = Logger.getLogger(EAMSelectionManager.class.getPackage().getName());

	public EAMSelectionManager(EAMController controller) {
		super(controller);
		_contextualMenuManager = new EAMContextualMenuManager(this, controller);
	}

	public EAMController getEAMController() {
		return (EAMController) getController();
	}
	...
	public FlexoObject getRootFocusedObject() {
		return getEAMController().getCurrentDisplayedObjectAsModuleView();
	}

	public EAMMenuBar getMenuBar() {
		return (EAMMenuBar) getController().getMenuBar();
	}
}

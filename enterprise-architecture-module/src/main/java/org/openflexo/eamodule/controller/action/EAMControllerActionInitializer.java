...
public class EAMControllerActionInitializer extends ControllerActionInitializer {
	...
	protected EAMController getEAMController() {
		return (EAMController) getController();
	}

	protected EAMSelectionManager getEAMSelectionManager() {
		return (EAMSelectionManager) getEAMController().getSelectionManager();
	}

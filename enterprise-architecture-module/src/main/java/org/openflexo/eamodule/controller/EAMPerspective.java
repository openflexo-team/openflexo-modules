...
public class EAMPerspective extends FlexoPerspective {

	static final Logger logger = Logger.getLogger(EAMPerspective.class.getPackage().getName());
	 ...
	 * @param name
	 */
	public EAMPerspective(FlexoController controller) {
		super("eam_perspective", controller);

 ...
 * @author yourname
 */
public class EAMWindowMenu extends WindowMenu {

	private static final Logger logger = Logger.getLogger(EAMWindowMenu.class.getPackage().getName());
	...
	protected EAMController eamController;

 ...
 * @author yourname
 */
public class EAMToolsMenu extends ToolsMenu {

	private static final Logger logger = Logger.getLogger(EAMToolsMenu.class.getPackage().getName());
	...
	public EAMToolsMenu(EAMController controller) {
		super(controller);

...
/**
 * ${moduleTrigramLower}Clipboard is intented to be the object working with the ${moduleTrigramLower}SelectionManager and storing copied, cutted and pasted objects. Handled
 * objects are instances implementing {@link org.openflexo.selection.SelectableView}.
 * 
 * @author yourname
 */
public class ${moduleTrigram}Clipboard extends FlexoClipboard {

	/** The Constant logger. */
	private static final Logger logger = Logger.getLogger(${moduleTrigram}Clipboard.class.getPackage().getName());

	/** The _${moduleTrigramLower} selection manager. */
	protected ${moduleTrigram}SelectionManager _${moduleTrigramLower}SelectionManager;

	/**
	 * Instantiates a new ${moduleTrigram} clipboard.
	 * 
	 ...
	 *            the cut menu item
	 */
	public ${moduleTrigram}Clipboard(${moduleTrigram}SelectionManager aSelectionManager, JMenuItem copyMenuItem, JMenuItem pasteMenuItem, JMenuItem cutMenuItem) {
		super(aSelectionManager, copyMenuItem, pasteMenuItem, cutMenuItem);
		_${moduleTrigramLower}SelectionManager = aSelectionManager;
		resetClipboard();
	}
	 ...
	 */
	public ${moduleTrigram}SelectionManager getSelectionManager() {
		return _${moduleTrigramLower}SelectionManager;
	}

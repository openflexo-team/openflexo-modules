...
public class ViewEditor extends Module<VEModule> {
	...
	public ViewEditor() {
		super(VEModule.VE_MODULE_NAME, VEModule.VE_MODULE_SHORT_NAME, VEModule.class, VEPreferences.class, "modules/flexoviewpointmodeller",
				"10803", "ve", VEIconLibrary.VE_SMALL_ICON, VEIconLibrary.VE_MEDIUM_ICON, VEIconLibrary.VE_MEDIUM_ICON_WITH_HOVER,
				VEIconLibrary.VE_BIG_ICON);

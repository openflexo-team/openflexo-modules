 ...
 * @author yourname
 */
public class XXXContextualMenuManager extends ContextualMenuManager {

	public XXXContextualMenuManager(XXXSelectionManager selectionManager, XXXController controller) {

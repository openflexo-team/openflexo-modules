...
public class TestXXXFibs extends GenericFIBTestCase {
	...
	@Test
	public void testXXXProjectBrowser() {
		validateFIB("Fib/XXXProjectBrowser.fib");
	}

	@Test
	public void testXXXProjectNaturePanel() {
		validateFIB("Fib/XXXProjectNaturePanel.fib");
	}

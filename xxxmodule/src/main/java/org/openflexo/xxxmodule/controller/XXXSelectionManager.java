...
public class XXXSelectionManager extends MouseSelectionManager {
	...
	protected static final Logger logger = Logger.getLogger(XXXSelectionManager.class.getPackage().getName());

	public XXXSelectionManager(XXXController controller) {
		super(controller);
		_contextualMenuManager = new XXXContextualMenuManager(this, controller);
	}

	public XXXController getXXXController() {
		return (XXXController) getController();
	}
	...
	public XXXMenuBar getMenuBar() {
		return (XXXMenuBar) getController().getMenuBar();
	}
}

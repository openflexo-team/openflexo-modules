...
import org.openflexo.xxxmodule.controller.XXXSelectionManager;
...
public class XXXControllerActionInitializer extends ControllerActionInitializer {
	...
	protected XXXController getXXXController() {
		return (XXXController) getController();
	}

	protected XXXSelectionManager getXXXSelectionManager() {
		return (XXXSelectionManager) getXXXController().getSelectionManager();
	}

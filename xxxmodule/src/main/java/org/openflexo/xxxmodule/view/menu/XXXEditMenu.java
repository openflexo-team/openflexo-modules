 ...
 * @author yourname
 */
public class XXXEditMenu extends EditMenu {

	private static final Logger logger = Logger.getLogger(XXXEditMenu.class.getPackage().getName());
	...
	public XXXEditMenu(XXXController controller) {
		super(controller);
